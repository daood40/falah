...
‏ADR-001 مُفعَّلة والهجرة المرحلية جارية وفق `MIGRATION.md`؛ الـPWA تبقى
المنتج الحي حتى M4. حالة FLUTTER GATE (M0): ‏12/12 اختبار sourcelock في
Dart، ‏analyze صفر مشاكل، ‏359 مفتاح ترجمة ARB، ثيم الورق القديم منقول.
