...
حتى M4. حالة FLUTTER GATE (M1 قيد التنفيذ): ‏19/19 اختبار Dart (sourcelock
12 + قرآن/بحث 7)، ‏analyze صفر مشاكل، ‏114 سورة أصولًا مدمجة بنفس بيانات
الـPWA (بصمات متطابقة)، 5 شاشات عاملة (رئيسية/سور/قارئ/سبحة/إعدادات)
بأربع حالات، Riverpod + go_router، لقطات تحقق حية. الخطة: `docs/SPEC.md`.
