...
| الرمز | HTTP | متى |
|---|---|---|
| `VALIDATION_ERROR` | 422 | مُعامل غير صالح، أو `limit` فوق السقف، أو عدد خارج مدى int4، أو حرف تحكم في قيمة |
| `NOT_FOUND` | 404 | لا سجل بهذا المعرّف |
| `UNAUTHORIZED` | 401 | مسار إداري بلا مفتاح صالح |
| `RATE_LIMITED` | 429 | تجاوز الحد — انظر `Retry-After` |
| `BAD_REQUEST` | 400 | جسم JSON تالف أو أكبر من 64KB، أو ترميز نسبة مئوية فاسد في المسار |
