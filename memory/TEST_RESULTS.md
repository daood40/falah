...
## 2026-09-17 (تحقق مقارن + API مستقل)

| ما شُغّل | النتيجة |
|---|---|
| verify:cross (مصادر مستقلة) | PASS — 6,236/6,236 تطابق حرفي مع إصدار حفص مستقل |
| ↳ بيانات السور مقابل مرجعين | 114/114 (عدد الآيات، الاسم، مكان وترتيب النزول) |
| ↳ حدود الصفحات | 604/604 · صفحة كل آية مقابل QCF v4: 6,180/6,236 |
| ↳ فروق محكَّمة بلا أي تعديل | 4 (رسم، جزء 11 في مرجع واحد، عرف السجدات، تنضيد QCF) |
| vitest (quran_api) | 98/98 PASS |
| vitest (PWA) | 75/75 PASS |
| flutter analyze/test | نظيف · 52/52 PASS |
